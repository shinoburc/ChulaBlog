...
/**
 * HTTPQuery specified ChulaBlog
 * @package ChulaBlog
 * @subpackage ChulaClass
 * @authors MIYAZATO Shinobu <shinobu@users.sourceforge.jp>
 * @version $Id: HTTPQuery.php,v 1.8 2005/05/05 16:51:38 shinobu Exp $
 */
class HTTPQuery{
    ...
    function __construct(){
        ...
        $this->guest_user_id = $Config->get_value("ChulaBlog","guest_user_id");
    }
